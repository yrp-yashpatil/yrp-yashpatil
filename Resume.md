...
**_Mumbai, India_** <br>
- Developed Excel-based carbon emissions models for ~28K monthly flights and collected & analyzed GHG Scope 1, 2 & 3
carbon emissions data from multiple departments and external partners, improving ESG data accuracy by 45%.
- Contributed to Mumbai Airport’s submission for Airports Council International (ACI) helping secure Level 5 Accreditation, the
topmost level in Airport Carbon Accreditation program for sustainability
...
**_Mumbai, India_** <br>
- Achieved 100% on-time aircraft turnaround on all 600+ assigned flights by leading & managing a team of 6-8 members with
zero delays, zero safety violations and flawless execution under pressure.
- Recognized with the “Best Technical Knowledge Award” for outstanding performance and ability to synthesize complex
operational requirements, demonstrating clarity required for effective client communication.
